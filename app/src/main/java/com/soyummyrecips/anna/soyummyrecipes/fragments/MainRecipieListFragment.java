...
public class MainRecipieListFragment extends Fragment {
    ...
    private RecipeNewListAdapter mAdapter;
    Context mContext;
    private GridLayoutManager lLayout;

    public MainRecipieListFragment() {
...
//        }
    ...
    private  void onCreateAdapter(){
        ...
        mAdapter = new RecipeNewListAdapter(eventResponseList.data);
